...
const historyData = [
    { id: "ORD-001", type: "order", items: "Iced Caramel Macchiato, Butter Croissant", date: "Today, 10:45 AM", points: "+45", amount: "₱320.00" },
    { id: "ORD-002", type: "order", items: "Hot Americano", date: "Yesterday, 08:30 AM", points: "+15", amount: "₱140.00" },
    { id: "RED-001", type: "reward", items: "Redeemed: Free Blueberry Muffin", date: "Oct 15, 2023", points: "-150", amount: "Free" },
    { id: "ORD-003", type: "order", items: "Matcha Latte", date: "Oct 12, 2023", points: "+20", amount: "₱180.00" },
    { id: "ORD-004", type: "order", items: "Spanish Latte, Choco Chip Cookie", date: "Oct 10, 2023", points: "+35", amount: "₱260.00" },
    { id: "RED-002", type: "reward", items: "Redeemed: 20% Off Coupon", date: "Oct 05, 2023", points: "-300", amount: "Discount" },
    { id: "ORD-005", type: "order", items: "Cold Brew", date: "Oct 01, 2023", points: "+25", amount: "₱190.00" },
]

export default function HistoryPage() {
    const [filter, setFilter] = useState<"all" | "order" | "reward">("all")

    const filteredHistory = historyData.filter(item => filter === "all" || item.type === filter)
