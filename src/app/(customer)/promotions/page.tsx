...
import { Tag, Clock, Sparkles, Ticket, ArrowRight, Star } from "lucide-react"
...
type PromoCategory = "all" | "new-users" | "seasonal" | "members-only"

const categories: { label: string; value: PromoCategory }[] = [
    { label: "All Promos", value: "all" },
    { label: "New Users", value: "new-users" },
    { label: "Seasonal Deals", value: "seasonal" },
...
const promotions = [
    {
        ...
        description: "Double the energy! Grab any espresso-based drink and get a second one completely free. Perfect for sharing.",
        image: promo1,
        category: "seasonal",
    ...
    },
    {
        ...
        description: "New to Daily Grind? Welcome to the family! Enjoy a 20% discount on your entire first order with us.",
        image: promo2,
        category: "new-users",
        endsIn: "Ends Tonight",
        code: "WELCOME20",
    ...
    {
        id: 3,
        title: "Free Pastry with Cold Brew",
        description: "Beat the heat. Buy our signature 12-hour steeped cold brew and choose any fresh pastry for free.",
        image: promo3,
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-card/90 backdrop-blur-xl">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4 leading-tight">
                                Half-Price on All <span className="text-primary italic">Signature Lattes</span>
                            </h2>
                            <p className="text-muted-foreground text-lg mb-8">
                                For this month only, enjoy any of our handcrafted signature lattes at 50% off. Because your afternoon pick-me-up shouldn't break the bank.
                            </p>
                            ...
                            >
                                ...
                                <div className="relative w-full aspect-[4/3] overflow-hidden">
                                    ...
                                    <div className="absolute top-4 right-4 bg-background/90 backdrop-blur-md px-3 py-1.5 rounded-full shadow-lg flex items-center gap-2 border border-border">
                                        ...
                                        <span className="text-xs font-bold text-foreground">{promo.endsIn}</span>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 flex flex-col flex-1">
                                    ...
                                    <div className="flex items-center justify-between pt-6 border-t border-border/50">
                                        <div className="bg-muted px-4 py-2 rounded-xl border border-dashed border-border flex items-center gap-2">
                                            ...
                                            <span className="font-mono text-sm font-bold text-foreground tracking-widest">{promo.code}</span>
                                        </div>
